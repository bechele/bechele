...
#   Copyright (C) <2015-2026>  <Rolf Jethon>
#
...
sub get_vars { 
  return($netport,$sendtonet,$sendtopca,$use_gamepad,$joystick_device,$serialport,$waittime_serial,$i2cport,$pwm_res,$i2c_address,$i2c_freq,$debug,$servores,$num_servos,$stepwidth,$play_full_mp3,$mp3loop,$block_popup_width,$matrix_popup_width,$max_out_pins,$dboutlist,$joystick_x_start,$joystick_x_end,$joystick_y_start,$joystick_y_end,$gamepad_start,$gamepad_stop,$gamepad_axis_y,$gamepad_axis_x,$gamepad_x_start,$gamepad_x_end,$gamepad_y_start,$gamepad_y_end,$num_servos_per_row,$OE,$NEXT,$PREV,$S1,$S2,$SHUT,$servosettings);
}
# common configuration file
#--------------------------------- globally used constants ---------------------------------
$netport=7625;                                  # the network port nodes are listening to - change only if you also recompile the nodes
$sendtonet=1;                                   # Output the moves to network devices via broadcast
$sendtopca=0;                                   # Output the moves to a directly connected PCA9685 PWM chip
$use_gamepad=0;                                 # 0= serial joystick 1= usb gamepad
$joystick_device=0;                             # joystick 0 or 1 - only if gamepad is active
$serialport="/dev/ttyS3";                       # serial port to read the joystick from
$waittime_serial=12000000;                      # wait for 12 ms (12000000 ns)
$i2cport="/dev/i2c-0";                          # i2c port to send the servo movements to
...
$play_full_mp3=0;                               # If 1 the mp3 plays till the end - no switch to the next mp3 on button press 
$mp3loop=0;                                     # after last mp3 - what to do - loop or stay with the last file
$block_popup_width=90;                          # The width for the block popup window
$matrix_popup_width=120;                        # The width for the matrix popup window
$max_out_pins=16;                               # Number of output pins for network PWM devices
$dboutlist="/tmp/dbout_";                       # File database output list is written to
#------- only relevant if joystick is in use ---------------
$joystick_x_start=0;                            # The joystick x mechanical start limit value
$joystick_x_end=939;                            # The joystick x mechanical end limit value
$joystick_y_start=0;                            # The joystick y mechanical start limit value
$joystick_y_end=939;                            # The joystick y mechanical end limit value
#use these values for joystick calibration:
#$joystick_x_start=0;                           # The joystick x mechanical start limit value
#$joystick_x_end=1024;                          # The joystick x mechanical end limit value
#$joystick_y_start=0;                           # The joystick y mechanical start limit value
#$joystick_y_end=1024;                          # The joystick y mechanical end limit value
...
$servosettings=[[203,390,0,170,603,'EyeRight left/right'],          # Servo 0 
	        #[150,700,0,150,700,'only for servo calibration'],   Set these values to do the first Servo calibration within servocalib.pl to determine the servo type limits
                ...
                [380,400,2,170,600,'Relay0,Relay1,Relay2,Relay3,Relay4,Relay5,Relay6,Relay7,Relay8,Relay9,Relay10,Relay11,Relay12,Relay13,Relay14,Relay15'],                     # Servo 24
